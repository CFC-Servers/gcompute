...
function self:Run (codeEditor, compilerStdOut, compilerStdErr, stdOut, stdErr)
	...
	menu:AddItem ("Run on self")
		:SetEnabled (GCompute.Execution.ExecutionService:CanCreateExecutionContext (GLib.GetLocalId (), "Self", nil))
	...
	menu:AddItem ("Run on server")
		:SetEnabled (GCompute.Execution.ExecutionService:CanCreateExecutionContext (GLib.GetLocalId (), "Server", nil))
	...
	menu:AddItem ("Run on client")
		:SetEnabled (GCompute.Execution.ExecutionService:CanCreateExecutionContext (GLib.GetLocalId (), "Clients", nil))
		:SetIcon ("icon16/user_go.png")
	...
	menu:AddItem ("Run on shared")
		:SetEnabled (GCompute.Execution.ExecutionService:CanCreateExecutionContext (GLib.GetLocalId (), "Shared", nil))
